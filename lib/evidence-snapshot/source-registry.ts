...
export const sourceDatasetRegistry = {
  ...
  clinic_profile: { tableName: "source_clinic_profile_raw", env: "SNOWFLAKE_CLINIC_PROFILE_FILE", defaultFile: "clinic_market_profile_ownership_demographics.csv", sourceId: "SNOWFLAKE-CSV-CLINIC-PROFILE", grain: "one clinic profile row", allowedUse: "local_demo_aggregate_decision_support", sensitivity: "internal", aiExposure: "aggregate_only" },
  clinic_activity: { tableName: "source_clinic_activity_raw", env: "SNOWFLAKE_CLINIC_ACTIVITY_FILE", defaultFile: "clinic_level_pre_post_ph_orders_prescriptions_sales.csv", sourceId: "SNOWFLAKE-CSV-CLINIC-ACTIVITY", grain: "one clinic x timeframe activity row", allowedUse: "local_demo_aggregate_decision_support", sensitivity: "internal", aiExposure: "aggregate_only" },
  ...
  regional_demand: { tableName: "source_regional_demand_raw", env: "SNOWFLAKE_ZIP_SALES_FILE", defaultFile: "annual_net_sales_by_customer_zip.csv", sourceId: "SNOWFLAKE-CSV-REGIONAL-DEMAND", grain: "one customer-address ZIP x year", allowedUse: "local_demo_cbsa_aggregate_only", sensitivity: "internal", aiExposure: "aggregate_only" },
