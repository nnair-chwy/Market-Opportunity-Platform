...
export function compileEvaluationPlan(
  ...
  const canAssumeNationalCohort = exploratoryQuestion
    ...
    && !(validatedIntent.topic === "local_growth" && /\b(awareness|campaign|ad|ads|advertis\w*|paid search|promotion|media|reach|growth test|test market|control market)\b/i.test(question))
