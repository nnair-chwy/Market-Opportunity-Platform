...
export async function proposeEvaluationPlanWithAi(
  ...
  return compileEvaluationPlan(question, response.output_parsed, "ai_proposed", perspectiveId, selectedGeographicContext);
}
