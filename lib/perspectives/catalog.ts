...
const cvcViews: PerspectiveView[] = [
  ...
  unavailableView({
    ...
    sourceLabel: "Clinic performance capability unavailable",
    evidenceBoundary: "Clinic performance remains unavailable pending an approved aggregate export, outcome definition, and owner approval.",
    emptyTitle: "Clinic performance unavailable",
    emptyMessage: "The clinic_performance capability is unavailable, so this view fails safely without imputed values.",
  }),
  {
    perspectiveId: "cvc",
