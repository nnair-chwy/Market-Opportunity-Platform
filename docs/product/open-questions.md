...
| OQ-033 | P1 | Which stable Google Ads location IDs and production bridge should replace the visible Census-assisted demo inference? | Marketing analytics, GIS, and data governance | Production Google Ads joins, comparison, scoring, and ranking; local Hypothesis context is available under ADR-031 |
| OQ-034 | P0 | Which governed growth-test objective, metric definitions, cohort rules, weights, exclusions, experiment design, and accountable approvers would replace the hypothesis-only local screening configuration? | Marketing Science, Growth, Finance, and governance | Production growth-test ranking, market selection, launch, and spend |
